...
public class Shop {
    ...
    public Shop() {
        dao = new DaoImplJDBC(); // Usamos JDBC por defecto
    ...
    private void setExpired() {
        ...
        if (product != null) {
            product.expire();
            System.out.println("Nuevo precio: " + product.getPublicPrice());
        }
    }
        ...
        try (FileWriter fw = new FileWriter(f, true);
            ...
            for (Sale sale : sales) {
                ...
                for (Product p : sale.getProducts()) {
                    productsLine.append(p.getName()).append(",").append(p.getPublicPrice()).append(";");
                }
